...
void analogMeter() {
  ...
  tft.drawRect(5, 3, 320, 158, TFT_BLACK);
...
void plotNeedle()
{
  ...
  tft.drawLine(int(1.33 * (120 + 20 * ltx - 1)), int(1.33 * (140 - 20)), int(osx - 1), int(osy), TFT_WHITE);
  tft.drawLine(int(1.33 * (120 + 20 * ltx)), int(1.33 * (140 - 20)), int(osx), int(osy), TFT_WHITE);
  tft.drawLine(int(1.33 * (120 + 20 * ltx + 1)), int(1.33 * (140 - 20)), int(osx + 1), int(osy), TFT_WHITE);
  ...
  tft.drawLine(int(1.33 * (120 + 20 * ltx - 1)), int(1.33 * (140 - 20)), int(osx - 1), int(osy), TFT_RED);
  tft.drawLine(int(1.33 * (120 + 20 * ltx)), int(1.33 * (140 - 20)), int(osx), int(osy), TFT_MAGENTA);
  tft.drawLine(int(1.33 * (120 + 20 * ltx + 1)), int(1.33 * (140 - 20)), int(osx + 1), int(osy), TFT_RED);
